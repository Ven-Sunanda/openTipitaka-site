...
window.OPENTIPITAKA_SITE_I18N = {
  ...
  languages: {
    en: {
      ...
      "badges.multiLang": "15 UI languages",
    ...
    vi: {
      ...
      "badges.multiLang": "15 ngôn ngữ giao diện",
      ...
      "features.dict.body": "Chạm vào từ Pāli để tra cứu; hỗ trợ bật/tắt/sắp xếp từ điển và từ điển người dùng.",
    ...
    bo: {
      ...
      "features.dict.body": "པ་ལིའི་ཚིག་ལ་གནོན་ན་ཚིག་དོན་འཚོལ་ཆོག་པ་དང་། ཚིག་མཛོད་སྤྱོད་པའམ་མི་སྤྱོད་པ། གོ་རིམ་སྒྲིག་པ། སྤྱོད་མཁན་གྱི་ཚིག་མཛོད་བཅས་ལ་རྒྱབ་སྐྱོར་བྱེད།",
    ...
    my: {
      ...
      "badges.multiLang": "UI ဘာသာ 15 မျိုး",
      ...
      "features.dict.body": "ပါဠိစကားလုံးကို နှိပ်၍ အဓိပ္ပာယ် ရှာဖွေနိုင်သည်—အဘိဓာန် ဖွင့်/ပိတ်၊ အစီအစဉ် ပြင်ခြင်းနှင့် အသုံးပြုသူ အဘိဓာန်များကို ပံ့ပိုးသည်။",
    ...
    th: {
      ...
      "badges.multiLang": "ภาษา UI 15 ภาษา",
      ...
      "features.dict.body": "คลิกที่คำบาลีเพื่อค้นหาคำจำกัดความ รองรับการเปิด/ปิด/จัดลำดับพจนานุกรม และพจนานุกรมของผู้ใช้",
    ...
    ja: {
      ...
      "features.dict.body": "パーリ語の単語をクリックするだけで意味を検索。辞書の有効化/無効化/並べ替え、およびユーザー辞書をサポートします。",
    ...
    ko: {
      ...
      "features.dict.body": "팔리 단어를 클릭하여 뜻을 검색할 수 있습니다. 사전 활성화/비활성화/정렬 및 사용자 사전을 지원합니다.",
    ...
    hi: {
      ...
      "features.dict.body": "पालि शब्द पर क्लिक करके अर्थ देखें। शब्दकोशों को सक्षम/अक्षम करने, क्रम बदलने और उपयोगकर्ता शब्दकोशों का उपयोग करें।",
    ...
    es: {
      ...
      "badges.multiLang": "15 idiomas de UI",
      ...
      "features.dict.body": "Haga clic en una palabra pali para buscar su definición. Soporta activar/desactivar/ordenar diccionarios y diccionarios de usuario.",
    ...
    id: {
      ...
      "features.dict.body": "Klik pada kata Pali untuk mencari definisinya. Mendukung pengaktifan/penonaktifan/pengurutan kamus serta kamus pengguna.",
    ...
    fr: {
      ...
      "badges.multiLang": "15 langues d’UI",
      ...
      "features.dict.body": "Cliquez sur un mot pali pour rechercher sa définition. Prend en charge l’activation/désactivation/tri des dictionnaires et les dictionnaires personnalisés.",
    ...
    de: {
      ...
      "badges.multiLang": "15 UI-Sprachen",
      ...
      "features.dict.body": "Klicken Sie auf ein Pali-Wort, um die Definition nachzuschlagen. Unterstützt Aktivierung/Deaktivierung/Sortierung von Wörterbüchern und Benutzerwörterbücher.",
    ...
    si: {
      ...
      "features.dict.body": "පාලි වචනයක් මත ක්ලික් කිරීමෙන් අර්ථය සොයාගත හැක. ශබ්දකෝෂ සක්‍රිය/අක්‍රිය/පිළිවෙල මෙන්ම පරිශීලක ශබ්දකෝෂ සඳහා සහාය දක්වයි.",
    ...
    mr: {
      ...
      "features.dict.title": "शब्दकोश कार्यप्रवाह",
      "features.dict.body": "अर्थ पाहण्यासाठी पाली शब्दावर टॅप करा. शब्दकोशांची क्रमवारी, सक्षम/अक्षम करणे आणि वापरकर्ता नोंदी व्यवस्थापित करा.",
